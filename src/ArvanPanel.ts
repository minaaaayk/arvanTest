...
/**
 * @link #{https://github.com/benawad/vsinder}
 * @export
 * @class ArvanPanel
 */
export class ArvanPanel {
  /**
   * Track the currently panel. Only allow a single panel to exist at a time.
   */
  public static currentPanel: ArvanPanel | undefined;

  public static readonly viewType = "arvanPanel";
  ...
  public static createOrShow(extensionUri: vscode.Uri) {
    ...
    if (ArvanPanel.currentPanel) {
      ArvanPanel.currentPanel._panel.reveal(column);
      ArvanPanel.currentPanel._update();
      return;
    }
    ...
    ArvanPanel.currentPanel = new ArvanPanel(panel, extensionUri);
  }

  public static kill() {
    ArvanPanel.currentPanel?.dispose();
    ArvanPanel.currentPanel = undefined;
  }
